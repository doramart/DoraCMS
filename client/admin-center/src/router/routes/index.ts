 ...
 */
const customRoutes: CustomRoute[] | any[] = [
  // {
  //   name: 'exception',
  //   path: '/exception',
  ...
  // },
  {
    ...
    children: [
      {
        name: 'remote-page_demo1',
        path: '/remote-page/demo1/:pathMatch(.*)*',
        component: 'view.remote-page',
        meta: {
          title: '远程组件Demo1',
          i18nKey: 'route.remote-page_demo1'
        }
      },
      {
        name: 'remote-page_ai-model-manage',
        path: '/remote-page/ai-model-manage/:pathMatch(.*)*',
        component: 'view.remote-page',
        meta: {
          title: 'AI模型管理',
          i18nKey: 'route.remote-page_ai-model-manage'
        }
      },
      {
        name: 'remote-page_ai-content-publish',
        path: '/remote-page/ai-content-publish/:pathMatch(.*)*',
        component: 'view.remote-page',
        meta: {
          title: 'AI内容发布',
          i18nKey: 'route.remote-page_ai-content-publish'
        }
      }
    ]
  }
