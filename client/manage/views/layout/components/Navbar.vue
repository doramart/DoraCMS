<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown
        v-if="loginState && loginState.userInfo"
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item @click.native="sysMessage">
            {{$t('main.myMessage')}}
            <el-badge
              v-show="loginState.noticeCounts > 0"
              class="mark"
              :value="loginState.noticeCounts"
            />
          </el-dropdown-item>
