export default {
  route: {
    ...
    getOneResource: "Get one resources",
    ...
    contentManageList: "Document List management",
    ...
    getOneContentCategory: "Get one category",
