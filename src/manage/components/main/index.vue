                    ...
                    <el-card class="box-card pannel-box">
                        ...
                        <div class="box-body">
                            <ul class="row basic-count">
                                <li>
                                    <i class="fa fa-fw fa-user"></i> 管理员:
                                    <span>{{basicInfo.adminUserCount}}</span>
                                </li>
                                <li>
                                    <i class="fa fa-fw fa-users"></i> 用户:
                                    <span>{{basicInfo.regUserCount}}</span>
                                </li>
                                <li>
                                    <i class="fa fa-fw fa-file-text-o"></i> 文档:
                                    <span>{{basicInfo.contentCount}}</span>
                                </li>
                                <li>
                                    <i class="fa fa-fw fa-comments-o"></i> 留言:
                                    <span>{{basicInfo.messageCount}}</span>
                                </li>
                            </ul>
                        </div>
                    </el-card>
