<template>
    <div class="dr-adminGroupForm">
        <el-dialog width="35%" size="small" :title="(formState.edit?$t('main.modify'):$t('main.addNew'))+(adsType == '1'?$t('ads.typePic'):$t('ads.textLink'))" :visible.sync="formState.show" :close-on-click-modal="false">
